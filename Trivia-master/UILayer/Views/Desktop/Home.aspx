    ...
    <form class="form-horizontal" role="form" runat="server">
        <div class="navbar  navbar-custom">
            <ul class="nav navbar-nav ">
                <li role="presentation"><a href="<%= Page.ResolveUrl("/Views/Desktop/Home.aspx") %>">Home</a></li>
                    ...
                    <div class="panel">
                        ...
                        <div style="padding-top: 30px" class="panel-body">
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                ...
                                <asp:TextBox ID="LoginPass" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                                <div class="form-control">
                                    <asp:TextBox ID="RegisterPasswordConfirm" runat="server"></asp:TextBox>
